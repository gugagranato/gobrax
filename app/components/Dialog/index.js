...
export function DialogComponent({ isOpen, closeModal, trucks }) {
              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="mb-6">
                    ...
                    <input defaultValue={trucksQtt} {...register('frota_total')} type="number" id="frota_total" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                  </div>
                  <div className="mb-6">
